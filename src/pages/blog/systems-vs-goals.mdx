...
export const meta = {
  ...
  description: 'What would make this project a success even if it fails?',
  category: 'Podcasting',
}
...
- audio recording
- [audio editing](https://www.christiangleitze.com/blog/three-steps-to-professional-sounding-podcast)
