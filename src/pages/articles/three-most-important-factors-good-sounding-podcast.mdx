...
export const meta = {
  ...
  date: '2020-03-10',
  title: 'The three most important factors of a good sounding podcast',
  description:
    'The three most important factors to consider for a good sounding podcast.',
}

export default (props) => <ArticleLayout meta={meta} {...props} />

[My podcast](https://linktr.ee/ConnectingDotsPod) didn’t sound good at first. Now it does. So let me share the 3 most important factors to consider for a better sounding podcast.
...
A Compressor makes quiet sounds louder and loud sounds quiet, so this effect evens out your audio recording. An EQ has the same goal as a Compressor but with different, more subtle means: you can target specific frequencies that you want to emphasize or that you want less of.
