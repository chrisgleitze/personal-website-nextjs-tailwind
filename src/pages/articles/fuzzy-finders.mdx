...
export const meta = {
  ...
  description: 'Supercharging your programming workflow with fuzzy finders.',
}

export default (props) => <ArticleLayout meta={meta} {...props} />

_Find a YouTube video of this article [here](https://www.youtube.com/watch?v=sT5pp0jDN6s)._
