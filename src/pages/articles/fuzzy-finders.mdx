...
With Vimium you can use Chrome efficiently with just your keyboard. Everything you need like [clicking a button on a website](https://youtube.com/shorts/eG7baTfOFfk), changing to another open tab or opening a website from your browser’s history is just a keystroke away. How I use it:

**Bookmark search**: Type a few characters and it finds the bookmark—even if you only vaguely remember what it’s called.\
**Browser history search**: Jump directly to a website you’ve visited recently. You don’t need to remember the exact title. A close approximation is enough.
