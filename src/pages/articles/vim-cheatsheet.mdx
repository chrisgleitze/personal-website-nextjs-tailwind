...
```text title="uninstalling Vim on Linux"
...
-- uninstall possible current installation of Vim on your system
...
Now you shoudl be able to run 'vim' from any folder.

Regularly pull the changes made to the vim/vim repo to your machine with the 'git pull' command.
