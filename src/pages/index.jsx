    ...
    <>
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            In my blog I share lessons I learned and thoughts I want to share.
            Written without the help of any AI tool. Topics include programming,
            podcasting, work and life in general.
          </p>
